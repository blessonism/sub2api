...
- **Sub2API fork workflow** — always include `.trellis/spec/guides/downstream-fork-workflow.md` for tasks that change code, docs, config templates, deployment files, Git branches, or release/deploy state
