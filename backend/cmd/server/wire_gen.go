...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionService := service.ProvideSubscriptionService(groupRepository, userSubscriptionRepository, userGroupRateRepository, billingCacheService, client, configConfig)
	...
	adminUsageCalibrationRepository := repository.NewAdminUsageCalibrationRepository(db)
	usageService := service.ProvideUsageService(usageLogRepository, userRepository, client, apiKeyAuthCacheInvalidator, adminUsageCalibrationRepository)
	opsRepository := repository.NewOpsRepository(db)
	usageBillingRepository := repository.NewUsageBillingRepository(client, db)
	userGroupAccountBindingRepository := repository.NewUserGroupAccountBindingRepository(db)
	userGroupAccountBindingResolver := service.NewUserGroupAccountBindingResolver(userGroupAccountBindingRepository)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, userGroupAccountBindingResolver, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, serviceUserPlatformQuotaRepository)
	...
	geminiMessagesCompatService := service.NewGeminiMessagesCompatService(accountRepository, groupRepository, userGroupAccountBindingResolver, gatewayCache, schedulerSnapshotService, geminiTokenProvider, rateLimitService, httpUpstream, antigravityGatewayService, configConfig)
	...
	channelMonitorUserHandler := handler.NewChannelMonitorUserHandler(channelMonitorService, settingService, gptIntelligenceService)
	...
	channelStatusService := service.NewChannelStatusService(settingService, apiKeyService, channelMonitorService, channelMonitorV2Service)
	channelStatusHandler := handler.NewChannelStatusHandler(channelStatusService)
	dashboardAggregationRepository := repository.NewDashboardAggregationRepository(db)
	dashboardStatsCache := repository.NewDashboardCache(redisClient, configConfig)
	dashboardService := service.ProvideDashboardService(usageLogRepository, dashboardAggregationRepository, dashboardStatsCache, configConfig, adminUsageCalibrationRepository)
	...
	campaignService := service.ProvideCampaignService(campaignRepository, adminService, authService)
	paymentService := service.ProvidePaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, affiliateService, campaignService, notificationEmailService)
	...
	adminUsageCalibrationService := service.NewAdminUsageCalibrationService(adminUsageCalibrationRepository, apiKeyAuthCacheInvalidator, billingCacheService)
	adminUsageHandler := handler.ProvideAdminUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, adminUsageCalibrationService, dashboardService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, accountCollectionHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, campaignHandler, lotteryCampaignHandler, complianceHandler, tokenUsagePolicyHandler, upstreamRelayGroupMonitoringHandler, conversationHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, pluginManager, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, conversationCaptureService, opsService, grokQuotaService, configConfig, coordinator)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, channelStatusHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, tokenUsageAutoPolicyRunner, lotteryCampaignRunner, campaignService, lotteryCampaignService, openAIQuotaAutoResetService)
