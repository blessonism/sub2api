...
// The AnnouncementEmailBroadcastFunc type is an adapter to allow the use of ordinary function as a Querier.
type AnnouncementEmailBroadcastFunc func(context.Context, *ent.AnnouncementEmailBroadcastQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AnnouncementEmailBroadcastFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AnnouncementEmailBroadcastQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AnnouncementEmailBroadcastQuery", q)
}

// The TraverseAnnouncementEmailBroadcast type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAnnouncementEmailBroadcast func(context.Context, *ent.AnnouncementEmailBroadcastQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAnnouncementEmailBroadcast) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAnnouncementEmailBroadcast) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AnnouncementEmailBroadcastQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AnnouncementEmailBroadcastQuery", q)
}
...
// The ConversationExportJobFunc type is an adapter to allow the use of ordinary function as a Querier.
type ConversationExportJobFunc func(context.Context, *ent.ConversationExportJobQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ConversationExportJobFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ConversationExportJobQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ConversationExportJobQuery", q)
}

// The TraverseConversationExportJob type is an adapter to allow the use of ordinary function as Traverser.
type TraverseConversationExportJob func(context.Context, *ent.ConversationExportJobQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseConversationExportJob) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseConversationExportJob) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ConversationExportJobQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ConversationExportJobQuery", q)
}
...
// The ConversationTurnFunc type is an adapter to allow the use of ordinary function as a Querier.
type ConversationTurnFunc func(context.Context, *ent.ConversationTurnQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ConversationTurnFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ConversationTurnQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ConversationTurnQuery", q)
}

// The TraverseConversationTurn type is an adapter to allow the use of ordinary function as Traverser.
type TraverseConversationTurn func(context.Context, *ent.ConversationTurnQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseConversationTurn) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseConversationTurn) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ConversationTurnQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ConversationTurnQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.AnnouncementEmailBroadcastQuery:
		return &query[*ent.AnnouncementEmailBroadcastQuery, predicate.AnnouncementEmailBroadcast, announcementemailbroadcast.OrderOption]{typ: ent.TypeAnnouncementEmailBroadcast, tq: q}, nil
	...
	case *ent.ConversationExportJobQuery:
		return &query[*ent.ConversationExportJobQuery, predicate.ConversationExportJob, conversationexportjob.OrderOption]{typ: ent.TypeConversationExportJob, tq: q}, nil
	...
	case *ent.ConversationTurnQuery:
		return &query[*ent.ConversationTurnQuery, predicate.ConversationTurn, conversationturn.OrderOption]{typ: ent.TypeConversationTurn, tq: q}, nil
