...
var (
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "target_kind", Type: field.TypeString, Size: 20, Default: "endpoint"},
		{Name: "account_id", Type: field.TypeInt64, Nullable: true},
	...
	ChannelMonitorHistoriesColumns = []*schema.Column{
		...
		{Name: "error_category", Type: field.TypeString, Nullable: true, Size: 40, Default: ""},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "openai_scheduler_overrides", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
