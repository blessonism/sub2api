...
type UpdateUserRequest struct {
	...
	VisibleGroupRates    map[int64]*float64                         `json:"visible_group_rates"`
	GroupAccountBindings *map[int64]service.UserGroupAccountBinding `json:"group_account_bindings"`
}
