...
type Group struct {
	...
	// ReasoningEffortMappings Anthropic/OpenAI/Codex 推理强度映射，可按模型精确名、前缀或后缀限定。
...
type AdminGroup struct {
	...
	OpenAISchedulerOverrides  domain.GroupOpenAISchedulerOverrides  `json:"openai_scheduler_overrides"`
...
// AccountListItem is the compact representation used by the admin lite list.
...
type AdminUsageLog struct {
	...
	// UpstreamReasoningEffort is the forwarded effort when it differs from the requested value.
