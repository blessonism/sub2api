...
func ProvideAdminHandlers(
	...
	accountCollectionHandler *admin.AccountCollectionHandler,
	...
	return &AdminHandlers{
		...
		AccountCollection:       accountCollectionHandler,
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, concurrencyService, billingCacheService, apiKeyService,
		usageRecordWorkerPool, errorPassthroughService, contentModerationService, conversationCaptureService, opsService, cfg)
	h.securityAuditCoordinator = coordinator
...
func ProvideAdminUsageHandler(
	...
	h.SetCalibrationService(calibrationService, dashboardService)
	return h
}
...
func ProvideHandlers(
	...
	channelStatusHandler *ChannelStatusHandler,
	...
	return &Handlers{
		...
		ChannelStatus:    channelStatusHandler,
		Admin:            adminHandlers,
...
var ProviderSet = wire.NewSet(
	...
	admin.NewAccountCollectionHandler,
