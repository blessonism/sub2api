...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	if s.cfg != nil && s.cfg.RunMode == config.RunModeSimple {
		*input = CreateGroupInput{Name: input.Name, Description: input.Description, Platform: input.Platform, RateMultiplier: 1, SubscriptionType: SubscriptionTypeStandard}
	}
	...
	group := &Group{
		...
		OpenAISchedulerOverrides:        input.OpenAISchedulerOverrides,
...
func (s *adminServiceImpl) UpdateGroup(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	if input.OpenAISchedulerOverrides != nil {
		group.OpenAISchedulerOverrides = *input.OpenAISchedulerOverrides
	}
...
func (s *adminServiceImpl) BatchSetGroupRateMultipliers(ctx context.Context, groupID int64, entries []GroupRateMultiplierInput) error {
	...
	for _, e := range entries {
		...
		if e.VisibleRateMultiplier != nil {
			...
			if !hasAtMostTwoDecimalPlaces(*e.VisibleRateMultiplier) {
