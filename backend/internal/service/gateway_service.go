...
func (s *GatewayService) recordUsageCore(ctx context.Context, input *recordUsageCoreInput, opts *recordUsageOpts) error {
	...
	if apiKey.GroupID != nil && apiKey.Group != nil {
		visibleMultiplier = s.getUserGroupVisibleRateMultiplier(ctx, user.ID, *apiKey.GroupID, apiKey.Group.VisibleRateMultiplier, baseMultiplier)
	}
	...
	peakMultiplier := 1.0
	if apiKey.GroupID != nil && apiKey.Group != nil {
		peakMultiplier = apiKey.Group.PeakMultiplierAt(now)
	}
	multiplier = baseMultiplier * peakMultiplier
	visibleMultiplier *= peakMultiplier
