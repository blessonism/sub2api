...
func (r *paymentOrderLifecycleRedeemRepo) ListUsedPaginated(context.Context, pagination.PaginationParams, string) ([]RedeemCode, *pagination.PaginationResult, error) {
	panic("unexpected call")
}
