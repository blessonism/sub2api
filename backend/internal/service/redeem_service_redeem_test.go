...
func (r *redeemRejectRepo) ListUsedPaginated(ctx context.Context, params pagination.PaginationParams, codeType string) ([]RedeemCode, *pagination.PaginationResult, error) {
