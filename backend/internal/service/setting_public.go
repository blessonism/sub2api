...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		TokenLeaderboardUserVisible: !isFalseSettingValue(settings[SettingKeyTokenLeaderboardUserVisible]),
...
// TokenLeaderboardRuntime is the lightweight view consumed by the user-facing
// leaderboard handler.
...
// GetTokenLeaderboardRuntime reads user-facing leaderboard controls directly
// from the settings store. Fail-open for visibility to preserve the historical
// default, and fail-empty for tooltip copy.
