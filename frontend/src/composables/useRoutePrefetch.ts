...
const PREFETCH_ADJACENCY: Record<string, string[]> = {
  ...
  '/admin/dashboard': ['/admin/accounts', '/admin/users', '/admin/balance-redemption'],
  '/admin/balance-redemption': ['/admin/dashboard', '/admin/users', '/admin/redeem'],
  ...
  '/usage': ['/keys', '/leaderboard'],
  '/leaderboard': ['/usage', '/dashboard'],
