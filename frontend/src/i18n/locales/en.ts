export default {
  ...
  admin: {
    ...
    upstreamCostCalibrations: {
      title: 'Upstream Cost Calibration',
      description: 'Measure real upstream deductions from balance deltas, generate priority suggestions, and apply them only after admin confirmation',
      create: 'New Calibration Task',
      edit: 'Edit Calibration Task',
      task: 'Task',
      targetGroup: 'Target Group',
      model: 'Test Model',
      modelPlaceholder: 'For example claude-sonnet-4-20250514',
      unit: 'Balance Unit',
      adapterType: 'Balance Adapter',
      enabled: 'Enable task',
      testPrompt: 'Test Prompt',
      sampleCount: 'Samples',
      prioritySettings: 'Priority Suggestion Rule',
      priorityStart: 'Start Priority',
      priorityStep: 'Step Per Rank',
      priorityRule: 'Suggest from {start}, +{step} per rank',
      accountSamples: 'Account Balance Samples',
      accountSamplesHint: 'The first version uses the manual adapter: fill before/after balances and optional latency for accounts in the same target group.',
      loadGroupAccounts: 'Load Group Accounts',
      noAccountsSelected: 'Select a target group and load accounts.',
      noGroupAccounts: 'No available accounts in this group',
      accounts: 'Accounts',
      account: 'Account',
      ...
      latestResultSummary: 'Valid {valid} / Invalid {invalid} / Suggestions {suggestions}',
      history: 'History',
      runNow: 'Run Calibration',
      running: 'Running',
      runConfirm: 'Run calibration task "{name}" now?',
      runCompleted: 'Calibration run completed',
      noRuns: 'No calibration history',
      viewDetails: 'View Evidence',
      runDetailTitle: 'Run #{id} Evidence',
      runEvidenceHint: 'Valid accounts are ranked by real cost from low to high. Invalid samples are excluded from suggestions.',
      totalAccounts: 'Total Accounts',
      validAccounts: 'Valid Accounts',
      invalidAccounts: 'Invalid Accounts',
      suggestions: 'Suggestions',
      noSuggestions: 'This run has no priority changes to apply.',
      reason: 'Reason',
      applied: 'Applied',
      applySuggestions: 'Apply Suggestions',
      applying: 'Applying...',
      applyConfirm: 'Apply priority suggestions from run #{id}? This updates account priorities in the target group.',
      appliedSuccess: 'Priority suggestions applied',
      deleteConfirm: 'Delete calibration task "{name}"? Its run history will also be deleted.',
      startedAt: 'Started',
      created: 'Calibration task created',
      updated: 'Calibration task updated',
      deleted: 'Calibration task deleted',
      loadFailed: 'Failed to load calibration tasks',
      saveFailed: 'Failed to save calibration task',
      loadAccountsFailed: 'Failed to load group accounts',
      runFailed: 'Failed to run calibration',
      historyFailed: 'Failed to load calibration history',
      detailFailed: 'Failed to load run detail',
      applyFailed: 'Failed to apply suggestions',
      deleteFailed: 'Failed to delete calibration task',
      nameRequired: 'Enter a task name',
      groupRequired: 'Select a target group',
      modelRequired: 'Enter a test model',
      accountsRequired: 'Select at least one account',
      sampleCountInvalid: 'Samples must be an integer from 1 to 10',
      priorityInvalid: 'Start priority and step must be positive integers',
      balanceRequired: 'Every account requires before and after balances',
      adapters: {
        manual: 'Manual balance sample'
      },
      runStatuses: {
        running: 'Running',
        success: 'Success',
