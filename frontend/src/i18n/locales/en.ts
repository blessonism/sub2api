export default {
  ...
  admin: {
    ...
    campaignRewards: {
      ...
      refresh: 'Refresh',
      createDefault: 'Create Default Campaign',
      listTitle: 'Campaigns',
      listDesc: 'The first phase allows only one active invite reward campaign at a time.',
      noCampaigns: 'No campaigns',
      noCampaignsDesc: 'Create a default campaign, then edit, publish, and settle it.',
      ...
      lifecycleWarmupDesc: 'Campaign has not started yet. Users can preview rules in advance.',
      ...
      lifecycleHintActive: 'Campaign is active. Preview settlement now; freeze the leaderboard before final settlement after the campaign ends.',
      ...
      lifecycleOperationHint: 'Recoverable pause is not enabled because there is no dedicated paused state. Use delete/archive to remove visibility, or copy as draft to reuse rules.',
      userPreview: 'User Preview',
      userPreviewDesc: 'Reuse the user-page lifecycle rules to preview the current hero-stage copy.',
      ...
      timelineEndDesc: 'Invite CTA is no longer emphasized after the campaign ends.',
      ...
      payoutNeedsFinalLocal: 'This page has no locally reviewable final settlement result. Run Final Settlement first, then confirm batch, payout amount, and withheld amount before one-click payout.',
      ...
      previewDisabledHint: 'Publish the campaign before previewing settlement',
