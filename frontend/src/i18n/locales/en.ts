export default {
  ...
  campaignRewards: {
    ...
    rulesTitle: 'Rules',
    fullRules: 'View full rules',
    defaultFullRules: 'Valid invites require invitee registration and qualified recharge. Bonus pool, leaderboard, and contribution rewards are audited and settled after the campaign. Final rewards depend on settlement results.',
    ...
    ratePending: 'pending',
    leaderboard: 'Leaderboard',
    leaderboardDesc: 'Top 50 by valid invites, qualified recharge, and qualification time.',
    rank: 'Rank',
    user: 'User',
