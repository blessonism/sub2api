export default {
  ...
  activities: {
    ...
    lotteryCampaignTitle: 'Token Lottery',
    activeLabel: 'Active',
    switcherLabel: 'Activity switcher',
  },

  lotteryCampaign: {
    emptyTitle: 'No active token lottery',
    emptyDescription: 'Token progress, lottery entries, and your results will appear here when a lottery is active.',
    defaultDescription: 'Reach the daily billable token threshold to join the lottery.',
    nextDraw: 'Next draw',
    pendingDraw: 'Pending',
    todayTokens: 'Today tokens',
    threshold: 'Threshold',
    entryCount: 'Entries',
    enroll: 'Enroll',
    enrolled: 'Enrolled in the lottery',
    enrollFailed: 'Enrollment failed',
    loadFailed: 'Failed to load token lottery',
    needMoreTokens: 'Keep using tokens to reach the threshold.',
    manualReady: 'Threshold reached. Enroll to enter this draw.',
    readyForDraw: 'You are in the draw pool.',
    myWinners: 'My results',
    noWinners: 'No winning records yet',
    prize: 'Prize',
    statuses: {
      draft: 'Draft',
      published: 'Published',
  ...
  campaignRewards: {
    ...
    description: 'Limited-time invite leaderboard, dynamic bonus pool, and reward estimates',
    defaultDescription: 'Invite new users to register and complete qualified recharges during the campaign to join ranking and contribution rewards.',
    refresh: 'Refresh Campaign',
    emptyTitle: 'No active invite reward campaign',
    ...
    unranked: 'Unranked',
    inviteEntry: 'My Invite Entry',
    inviteEntryDesc: 'Share your invite code or link. Only users who register and qualify during the campaign count toward rewards.',
    ...
    progressStart: 'Share your invite link. Friends count toward rewards after registration and qualified recharge.',
    distanceToPrevious: '{count} more valid invite(s) to catch the previous rank.',
    distanceToTop10: '{count} more valid invite(s) to reach Top 10.',
    rankSecured: 'Current rank #{rank}. Keep inviting to improve rank reward odds.',
    rulesTitle: 'Rules',
    ...
    lifecycle: {
      ...
      warmup: 'Starts in',
      warmupDesc: 'The campaign is starting soon. Get your invite link ready.',
      active: 'Ends in',
      activeDesc: 'Invite qualified users to join reward allocation.',
      ...
      paid: 'Rewards paid',
      paidDesc: 'Campaign rewards have been paid. Review final results here.',
    ...
    inviteStatusNotes: {
      registered: 'Registered and waiting for qualified recharge.',
      ...
      effective: 'Included in reward estimate.',
  ...
  admin: {
    ...
    lotteryCampaigns: {
      title: 'Token Lottery',
      description: 'Configure token threshold lotteries, draw schedule, prizes, and balance payouts.',
      create: 'Create lottery',
      createDialogTitle: 'Create token lottery',
      emptyTitle: 'No lottery campaigns',
      emptyDescription: 'Create one to publish, sync entries, and draw winners.',
      defaultName: 'Token Threshold Lottery',
      defaultDescription: 'Reach the daily billable token threshold to join the lottery.',
      name: 'Campaign name',
      descriptionLabel: 'Description',
    ...
    campaignRewards: {
      ...
      defaultDescription: 'Limited-time invite leaderboard campaign with dynamic bonus pool and contribution rewards.',
      ...
      lifecycleOperationHint: 'Use delete/archive when a campaign must be taken offline; copy as draft when you need to reuse rules.',
