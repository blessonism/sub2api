  ...
  admin: {
    ...
    upstreamRelayGroupMonitoring: {
      ...
      tabs: {
        ...
        recommendations: 'Priority Suggestions',
        policy: 'Policy Preview'
      },
      overview: {
        activeConnectors: 'Active Connectors',
        needsReauth: 'Needs Re-auth',
        needsReauthHint: 'Address credentials first',
        enabledCandidates: 'Enabled Candidates',
        failedCandidates: 'Probe Failures',
        failedCandidatesHint: 'Failed & auth-error candidates',
        pendingSuggestions: 'Pending Suggestions',
        pendingSuggestionsHint: 'Review risks before applying',
      ...
      candidates: {
        ...
        enabled: 'Enabled',
	        ...
	        todayUsageTokensSynced: '{tokens} tokens today, synced {time}',
      ...
      candidateForm: {
        ...
        labelTargetGroup: 'Local Priority Target Group',
