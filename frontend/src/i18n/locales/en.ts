  ...
  admin: {
    ...
    upstreamRelayGroupMonitoring: {
      ...
      monitoring: {
        ...
        description: 'Configure how often the system refreshes upstream rates and candidate probe data. This phase only saves configuration and supports manual triggers; it does not apply priority automatically.',
        updatedAt: 'Updated {time}',
