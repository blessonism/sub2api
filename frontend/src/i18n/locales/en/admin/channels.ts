export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        targetKind: 'Probe Target',
        targetKindEndpoint: 'External upstream',
        targetKindEndpointHint: 'Probe the upstream directly to check that upstream itself',
        targetKindGatewayGroup: 'This site group',
        targetKindGatewayGroupHint: 'Probe via the local gateway (auto failover within the group); result reflects group-level availability',
        targetKindGatewayGroupGuide: 'Group probe: set endpoint to this site\'s public URL (use "Use current domain"), and pick a user API key bound to the target group. The group counts as available when any upstream works.',
