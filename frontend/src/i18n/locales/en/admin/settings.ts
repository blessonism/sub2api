export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexBasePromptInjection: 'Codex Base Prompt Injection',
        codexBasePromptInjectionHint: 'Automatically inject the Codex Base Prompt when a request has no instructions. Disable to leave it empty; client-provided instructions are unchanged.',
        codexBasePrompt: 'Codex Base Prompt',
        codexBasePromptFallbackModel: 'GPT-5.5 / Other Models',
        codexBasePromptPlaceholder: 'Leave empty to use the built-in Codex Prompt, or load it and edit it as a custom prompt.',
        loadBuiltinCodexBasePrompt: 'Load Built-in Prompt',
        clearCodexBasePrompt: 'Clear and Use Built-in',
        viewBuiltinCodexBasePrompt: 'View Built-in Prompt',
      ...
      customMenu: {
        ...
        description: 'Add custom pages to the sidebar navigation. Embed them in-app, or open them in a new tab like Buy Plan. Each page can be visible to regular users or administrators.',
        ...
        openMode: 'Open Mode',
        openModeEmbed: 'Embed in app',
        openModeExternal: 'Open in new tab',
        openModeHint: 'New-tab links leave this site and are not embedded in an iframe.',
        iconSvg: 'SVG Icon',
