export default {
  common: {
    ...
    channelStatusApi: {
      ...
      description: 'Use a user API key to query channel status for the groups visible to that user. The endpoint reports status only; it does not provide polling or retry scripts.',
      ...
      responseItems: 'items: channel group status visible to the current user.',
      responseConnected: 'connected: whether every returned item is available.',
      responseKeyGroup: 'key_group_connected: whether the group bound to this API key is available.',
