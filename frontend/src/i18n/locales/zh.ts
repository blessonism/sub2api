export default {
  ...
  activities: {
    ...
    lotteryCampaignTitle: 'Token 抽奖',
    activeLabel: '进行中',
    switcherLabel: '活动切换',
  },

  lotteryCampaign: {
    emptyTitle: '当前没有进行中的 Token 抽奖活动',
    emptyDescription: '活动开启后，今日 Token 进度、抽奖资格和中奖结果会显示在这里。',
    defaultDescription: '今日成功计费 Token 达标后即可参与抽奖。',
    nextDraw: '下次开奖',
    pendingDraw: '待确认',
    todayTokens: '今日 Token',
    threshold: '达标门槛',
    ...
    enrolled: '已报名参与抽奖',
    enrollFailed: '报名失败',
    loadFailed: '加载 Token 抽奖活动失败',
    needMoreTokens: '继续使用 Token，达到门槛后即可参与。',
    manualReady: '已达到门槛，请报名后进入本期开奖池。',
    readyForDraw: '已进入开奖池，请等待开奖。',
    myWinners: '我的中奖结果',
    noWinners: '暂无中奖记录',
    prize: '奖项',
    statuses: {
  ...
  campaignRewards: {
    title: '邀请好友赢奖金',
    description: '限时邀请排行榜活动、动态奖金池和奖励预估',
    defaultDescription: '邀请新用户注册并在活动期内完成有效充值，即可参与排行榜和贡献奖励。',
    refresh: '刷新活动',
    emptyTitle: '当前没有进行中的邀请奖励活动',
    ...
    unranked: '未上榜',
    inviteEntry: '我的邀请入口',
    inviteEntryDesc: '分享专属邀请码或链接，活动期内注册并达标的好友才计入奖励。',
    threshold: '有效充值门槛',
    myCode: '我的邀请码',
    inviteLink: '邀请链接',
    myLink: '我的邀请链接',
    ...
    progressStart: '分享邀请链接后，好友注册并完成有效充值即可计入活动奖励。',
    distanceToPrevious: '距离上一名还差 {count} 个有效邀请。',
    distanceToTop10: '距离 Top10 还差 {count} 个有效邀请。',
    rankSecured: '当前排名 #{rank}，继续邀请可提高排名奖励机会。',
    rulesTitle: '活动规则',
    ...
    lifecycle: {
      ...
      warmup: '距活动开始',
      warmupDesc: '活动即将开始，先准备好你的邀请链接。',
      active: '距活动结束',
      activeDesc: '邀请有效用户达标后即可参与奖励分配。',
      auditing: '审核预计剩余',
  ...
  admin: {
    ...
    lotteryCampaigns: {
      title: 'Token 抽奖',
      description: '配置 Token 达标抽奖、开奖节奏、奖项和余额发放。',
      create: '创建抽奖活动',
      createDialogTitle: '创建 Token 抽奖活动',
      emptyTitle: '暂无抽奖活动',
      emptyDescription: '创建后可发布、同步资格并手动开奖。',
      defaultName: 'Token 达标抽奖',
      defaultDescription: '今日成功计费 Token 达标即可参与抽奖。',
      name: '活动名称',
    ...
    campaignRewards: {
      ...
      defaultName: '邀请好友赢奖金',
      defaultDescription: '限时邀请排行榜活动，支持动态奖金池和贡献奖励。',
      ...
      lifecycleOperationHint: '活动需临时下线时请使用删除/归档；需要沿用规则时请复制为草稿。',
      userPreview: '用户端展示',
