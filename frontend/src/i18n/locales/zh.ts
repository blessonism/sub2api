export default {
  ...
  admin: {
    ...
    upstreamCostCalibrations: {
      title: '上游成本校准',
      description: '按同组账号的余额前后差计算真实扣费，生成优先级调整建议，确认后再应用',
      create: '新建校准任务',
      edit: '编辑校准任务',
      task: '任务',
      targetGroup: '目标分组',
      ...
      testPrompt: '测试指令',
      sampleCount: '测试次数',
      prioritySettings: '优先级建议规则',
      priorityStart: '起始优先级',
      priorityStep: '每名递增',
      priorityRule: '建议从 {start} 开始，每名 +{step}',
      accountSamples: '账号余额采样',
      accountSamplesHint: '第一版使用 manual 适配器：为同一目标分组内账号填写测试前余额、测试后余额和可选延迟。',
      loadGroupAccounts: '加载分组账号',
      noAccountsSelected: '请选择目标分组并加载账号。',
      noGroupAccounts: '该分组下没有可用账号',
      accounts: '账号数',
      account: '账号',
      ...
      lastRun: '上次运行',
      latestResult: '最近结果',
      latestResultSummary: '有效 {valid} / 异常 {invalid} / 建议 {suggestions}',
      history: '历史',
      runNow: '立即校准',
      running: '校准中',
      runConfirm: '确认立即运行校准任务「{name}」？',
      runCompleted: '校准运行完成',
      noRuns: '暂无校准历史',
      viewDetails: '查看证据',
      runDetailTitle: '运行 #{id} 证据链',
      runEvidenceHint: '有效账号按真实扣费从低到高排序，异常样本不参与建议。',
      totalAccounts: '总账号',
      validAccounts: '有效账号',
      invalidAccounts: '异常账号',
      suggestions: '建议数',
      noSuggestions: '本次运行没有需要应用的优先级变更。',
      reason: '原因',
      applied: '已应用',
      applySuggestions: '应用建议',
      applying: '应用中...',
      applyConfirm: '确认应用运行 #{id} 的优先级建议？这会更新目标分组内账号优先级。',
      appliedSuccess: '优先级建议已应用',
      deleteConfirm: '确认删除校准任务「{name}」？历史运行记录也会被删除。',
      startedAt: '开始时间',
      created: '校准任务已创建',
      updated: '校准任务已更新',
      deleted: '校准任务已删除',
      loadFailed: '加载校准任务失败',
      saveFailed: '保存校准任务失败',
      loadAccountsFailed: '加载分组账号失败',
      runFailed: '运行校准失败',
      historyFailed: '加载校准历史失败',
      detailFailed: '加载运行详情失败',
      applyFailed: '应用建议失败',
      deleteFailed: '删除校准任务失败',
      nameRequired: '请输入任务名称',
      groupRequired: '请选择目标分组',
      modelRequired: '请输入测试模型',
      accountsRequired: '请至少选择一个账号',
      sampleCountInvalid: '测试次数必须是 1 到 10 的整数',
      priorityInvalid: '起始优先级和递增步长必须是正整数',
      balanceRequired: '每个账号都需要填写测试前余额和测试后余额',
      adapters: {
        manual: '手动余额采样'
      },
      runStatuses: {
