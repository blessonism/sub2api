  ...
  admin: {
    ...
    upstreamRelayGroupMonitoring: {
      ...
      usageHistory: {
        ...
        keyword: '关键词',
        onlyAnomalies: '仅看异常',
        summaryCost: '当前页 Actual Cost',
        summaryTokens: '当前页 Token',
        summaryConnectors: '当前页连接器',
        summaryGroups: '当前页分组',
        ...
        currentPageScopeHint: '当前页汇总：展示 {shown} / 已加载 {loaded} 条；筛选命中共 {total} 条，跨页总计需翻页查看。',
        ...
        groupSubtotalCost: '成本 {value}',
        groupSubtotalTokens: 'Token {value}',
        groupSubtotalGroups: '{n} 个分组',
