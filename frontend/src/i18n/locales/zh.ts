  ...
  admin: {
    ...
    upstreamRelayGroupMonitoring: {
      ...
      tabs: {
        ...
        recommendations: 'Priority 建议',
        policy: '策略预览'
      },
      overview: {
        activeConnectors: '可用连接器',
        needsReauth: '需重新登录',
        needsReauthHint: '优先处理凭证状态',
        enabledCandidates: '启用候选',
        failedCandidates: '探测失败',
        failedCandidatesHint: '失败与认证异常候选',
        pendingSuggestions: '待应用建议',
        pendingSuggestionsHint: '应用前需确认风险',
        latestSync: '最近同步',
      ...
      candidates: {
        ...
        enabled: '启用',
	        ...
	        todayUsageTokensSynced: '今日 {tokens} tokens，同步于 {time}',
      ...
      candidateForm: {
        ...
        labelTargetGroup: '本地 priority 目标分组',
