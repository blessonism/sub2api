export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexBasePromptInjection: 'Codex Base Prompt 注入',
        codexBasePromptInjectionHint: '当请求未提供 instructions 时，自动注入 Codex Base Prompt。关闭后保持为空；客户端自行提供的 instructions 不受影响。',
        codexBasePrompt: 'Codex Base Prompt 正文',
        codexBasePromptFallbackModel: 'GPT-5.5 / 其他模型',
        codexBasePromptPlaceholder: '留空时使用内置 Codex Prompt；也可以载入内置正文后编辑。',
        loadBuiltinCodexBasePrompt: '载入内置 Prompt',
        clearCodexBasePrompt: '清空并恢复内置',
        viewBuiltinCodexBasePrompt: '查看内置 Prompt',
      ...
      customMenu: {
        title: '自定义菜单页面',
        description: '添加自定义页面到侧边栏导航。可选择站内嵌入，或像购买套餐一样新标签直跳。每个页面可以设置为普通用户或管理员可见。',
        itemLabel: '菜单项 #{n}',
        name: '菜单名称',
        ...
        openMode: '打开方式',
        openModeEmbed: '站内嵌入',
        openModeExternal: '新标签直跳',
        openModeHint: '新标签直跳会离开本站，不再使用站内 iframe。',
        iconSvg: 'SVG 图标',
